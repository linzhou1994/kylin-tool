 ...
 * @author: linzhou
 * @description : GetApacheHttpProxyHandler
 */
@Component
public class GetApacheHttpProxyHandler implements ApacheHttpProxyHandler {

  @Override
  public List<HttpRequestMethod> getRequestMethods() {
    return Arrays.asList(HttpRequestMethod.GET, HttpRequestMethod.NULL);
  }

  @Override
  public HttpRequestBase getRequest(HttpRequestContext context) throws Throwable {
    return new HttpGet(context.getHttpUrl());
  }
}
