package com.kylin.http.client.biz.handler.analysis.method.impl.header;
 ...
 */
@Component
public class HttpHeaderHandler implements AnalysisMethodParamHandler {
    @Override
    public Object analysisMethodParam(Object param, Annotation[] annotations) throws IOException {
        if (param instanceof HttpHeader){
            return param;
        }
        return null;
    }
